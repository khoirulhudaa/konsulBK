...
if(isset($_GET['op'])) {
        ...
        if($op == 'delete') {
            $id             = $_GET['id'];
            $sql            = "delete from keluhan where id_keluhan = '$id'";
...
<div class="row">
    ...
    <div class="col-9 overflow-auto">
        <h1 class="fw-bold fs-2 mt-5 ms-4">Sesi 1</h1>
                ...
                <table class="table table-responsive table-hover">
                    ...
                    <?php
                         ...
                         if(isset($_GET['search'])) {
                             $sql = "SELECT * FROM keluhan WHERE username LIKE '%".$_GET['search']."%'";
                         }
                        ...
                        <tr>    
                            ...
                            <th><?php echo $tgl ?></th>
                            <th>
                                <a href="detail.php?op=detail&id=<?php echo $id ?>">
                                    <button type="button" class="btn btn-primary"><img src="./image/eye.png" alt="eye" class="eye" /></button>
                                </a>
                                <br>
                                <br>
                                <a href="keluhan.php?op=delete&id=<?php echo $id ?>" class="alert_notif">
