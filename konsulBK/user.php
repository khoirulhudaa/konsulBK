                ...
                <table class="table table-responsive table-hover">
                    ...
                    <?php
                        ...
                        if(isset($_GET['search'])) {
                            $sql = "SELECT * FROM user WHERE username LIKE '%".$_GET['search']."%'";
                        }
                        ...
                        <tr>
                            ...
                            <th><?php echo $sesi ?></th>
                            <th>
                                <a href="editSesi.php?op=edit&id=<?php echo $id ?>">
                                    <button type="button" class="btn btn-primary"><img src="./image/pen.svg" alt="trash" class="trash" /></button>
                                </a>
                                <br>
                                <br>
                                <a href="user.php?op=delete&id=<?php echo $id ?>" class="alert_notif">
