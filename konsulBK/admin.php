...
<div class="row">
    <div class="col-3 position-sticky fixed-top bg-primary list-white" id="menu-left">
        <ul class="position-fixed ms-1 mt-4 sticky-top pt-5">
            <li class="list-unstyled d-flex mb-4 text-white"><div class="icon bg-primary"><img src="./image/admin.png" style="color:white;margin-right: 16px;" width="25" alt="icon" /></div>Data admin</li><br>
    ...
    <div class="col-9 overflow-auto">
        <h1 class="fw-bold fs-2 mt-5 ms-4">Hai, <?php echo $_SESSION['username_admin'] ? $_SESSION['username_admin'] : "" ?> 👋</h1>
        <p class="ms-4">Ciptakan data yang effisien dan efektif</p>
        <br>
        <div class="container">
            <div class="mb-3 d-flex" style="width: 100%;margin-top: 48px;" id="search">
                <form action="" method="get" class="d-flex">
                    <input type="text" class="form-control" style="width: 241px" placeholder="Cari nama disini...." name="search" value="<?php echo $search ?>" id="exampleInputEmail1" />
                    <button class="btn btn-primary ms-2" type="submit" name="kirim2"><img src="./image/search.png" alt="search icon" width="16" /></button>
                </form>
            </div>
            <a href="add.php">
                <button type="submit" name="simpan" class="btn mt-0 ms-0 mb-4 btn-primary">Tambah admin</button>
            </a>
                ...
                <table class="table table-responsive table-hover">
                    ...
                    <?php
                        ...
                        if(isset($_GET['search'])) {
                            $sql = "SELECT * FROM admin WHERE username LIKE '%".$_GET['search']."%'";
                        }
                        $getData = mysqli_query($koneksi, $sql);
                            ...
                            while($data = mysqli_fetch_array($getData)) {
                                ...
                                $jk_admin = $data['jk_admin'];
                                $no_telephone = $data['no_telephone'];
                        ?>
                        <tr>
                            <th><?php echo $no++ ?></th>      
                            <th><?php echo $username ?></th>
                            <th><?php echo $alamat_admin ?></th>
                            <th><?php echo $jk_admin ?></th>
                            <th><?php echo $no_telephone ?></th>
                            <th>
                                <a href="edit.php?op=edit&id=<?php echo $id ?>">
                                    <button type="button" class="btn btn-primary"><img src="./image/pen.svg" alt="trash" class="trash" /></button>
                                </a>
                                <br>
                                <br>
                                <a href="admin.php?op=delete&id=<?php echo $id ?>" class="alert_notif">
