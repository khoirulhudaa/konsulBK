...
if(isset($_GET['op'])) {
        ...
        if($op == 'delete') {
            $id             = $_GET['id'];
            $sql            = "delete from keluhan5 where id_keluhan = '$id'";
...
<div class="row">
    ...
    <div class="col-9 overflow-auto">
        <h1 class="fw-bold fs-2 mt-5 ms-4">Sesi 5</h1>
        ...
        <div class="container mt-5">
            ...
            <form action="project.php" method="post" enctype="multipart/form-data">
                <table class="table table-responsive table-hover">
                    ...
                    <?php
                         $sql = "select * from keluhan5";
                         if(isset($_GET['search'])) {
                             $sql = "SELECT * FROM keluhan5 WHERE username LIKE '%".$_GET['search']."%'";
                         }
                        $getData = mysqli_query($koneksi, $sql);
                            ...
                            while($data = mysqli_fetch_array($getData)) {
                                ...
                                $keluhan_pertama = $data['instagram'];
                        ...
                        <tr>    
                            ...
                            <th><?php echo $tgl ?></th>
                            <th>
                                <a href="detail5.php?op=detail&id=<?php echo $id ?>">
                                    <button type="button" class="btn btn-primary"><img src="./image/eye.png" alt="eye" class="eye" /></button>
                                </a>
                                <br>
                                <br>
                                <a href="keluhan5.php?op=delete&id=<?php echo $id ?>" class="alert_notif">
