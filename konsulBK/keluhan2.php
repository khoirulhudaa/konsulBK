...
if(isset($_GET['op'])) {
        ...
        if($op == 'delete') {
            $id             = $_GET['id'];
            $sql            = "delete from keluhan2 where id_keluhan = '$id'";
...
<div class="row">
    ...
    <div class="col-9 overflow-auto">
        <h1 class="fw-bold fs-2 mt-5 ms-4">Sesi 2</h1>
            ...
            <form action="project.php" method="post" enctype="multipart/form-data">
                <table class="table table-responsive table-hover">
                    <thead>
                        ...
                        <th scope="col">LK1 - sesi 2</th>
                        <th scope="col">Tgl konsultasi</th>
                        <th scope="col">Opsi</th>
                        </tr>
                    </thead>
                    <?php
                         $sql = "select * from keluhan2";
                         if(isset($_GET['search'])) {
                             $sql = "SELECT * FROM keluhan2 WHERE username LIKE '%".$_GET['search']."%'";
                         }
                        ...
                        <tr>    
                            ...
                            <th><?php echo $tgl ?></th>
                            <th>
                                <a href="detail2.php?op=detail&id=<?php echo $id ?>">
                                    <button type="button" class="btn btn-primary"><img src="./image/eye.png" alt="eye" class="eye" /></button>
                                </a>
                                <br>
                                <br>
                                <a href="keluhan2.php?op=delete&id=<?php echo $id ?>" class="alert_notif">
