...
$op = "";
    ...
    if($op == 'detail') {
        $id = $_GET['id'];
        $sql = "select * from keluhan where id_keluhan = '$id'";
        ...
        <div class="col-9 overflow-y-auto overflow-x-hidden ps-4">
            ...
            <section class="section1">
                ...
                <div class="form-floating">
                    <textarea class="form-control" name="lk1_s1" id="floatingTextarea2" style="height: 300px;font-size: 15px;line-height: 1.8em"><?php echo $lk1_s1 ?></textarea>
                </div>
                <h2 class="judul-sesi">
                    Lembar kerja 2
                </h2>
                ...
                <div class="form-floating">
                    <textarea class="form-control" name="lk2_s1" id="floatingTextarea2" style="height: 300px;font-size: 15px;line-height: 1.8em"><?php echo $lk2_s1 ?></textarea>
                </div>
            </section> 
        </div>
    </div>
