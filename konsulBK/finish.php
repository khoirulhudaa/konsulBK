...
<div class="success">
    <img src="./image/bk1.png" alt="check-image" class="check">
    <h1>Untuk konsultasi sesi <?php echo $_SESSION['sesi'] ?> sudah selesai</h1>
    <p>Tunggu arahan dari konselor untuk melakukan sesi konsultasi berikutnya</p>
