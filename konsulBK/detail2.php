...
$op = "";
    ...
    if($op == 'detail') {
        $id = $_GET['id'];
        $sql = "select * from keluhan2 where id_keluhan = '$id'";
        $sql2 = mysqli_query($koneksi, $sql);
        $sql3 = mysqli_fetch_array($sql2);
        $username = $sql3['username'];
        $jk_user = $sql3['jk_user'];
        $lk1_s2 = $sql3['lk1_s2'];
        $lk2a_s2 = $sql3['lk2a_s2'];
        $lk2b_s2 = $sql3['lk2b_s2'];
        $lk2c_s2 = $sql3['lk2c_s2'];
        $lk2d_s2 = $sql3['lk2d_s2'];
        $lk2e_s2 = $sql3['lk2e_s2'];
    ...
    <div class="col-3 position-sticky fixed-top bg-primary list-white" id="side">
        ...
        <div class="col-9 overflow-y-auto overflow-x-hidden ps-4">
            ...
            <section class="section1">
                    ...
                    <p class="title-textarea">Buatlah daftar semua rencana karir yang Anda pikirkan untuk dilakukan!</p>
                    <div class="form-floating">
                        <textarea class="form-control" name="lk1_s2" id="floatingTextarea2" style="height: 300px;font-size: 15px;line-height: 1.8em"><?php echo $lk1_s2 ?></textarea>
                    </div>

                    <h2 class="judul-sesi">
                        Lembar kerja 2
                    </h2>
                    <p>Jawablah pertanyaan-pertanyaan berikut ini!</p>
                    <p class="title-textarea">1. Siapa yang anda kagumi ketika anda tumbuh dewasa?</p>
                    <div class="form-floating">
                        <textarea class="form-control" name="lk2a_s2" id="floatingTextarea2" style="height: 300px;font-size: 15px;line-height: 1.8em"><?php echo $lk2a_s2 ?></textarea>
                    </div>
                    <br>
                    <p class="title-textarea">2. Apa saja tiga majalah atau acara TV atau siaran YT favorit Anda?</p>
                    <div class="form-floating">
                        <textarea class="form-control" name="lk2b_s2" id="floatingTextarea2" style="height: 300px;font-size: 15px;line-height: 1.8em"><?php echo $lk2b_s2 ?></textarea>
                    </div>
                    <br>
                    <p class="title-textarea">3. Apa cerita favoritmu saat ini?</p> 
                    <div class="form-floating">
                        <textarea class="form-control" name="lk2c_s2" id="floatingTextarea2" style="height: 300px;font-size: 15px;line-height: 1.8em"><?php echo $lk2c_s2 ?></textarea>
                    </div>
                    <br>
                    <p class="title-textarea">4. Apa ucapan favoritmu?</p>
                    <div class="form-floating">
                        <textarea class="form-control" name="lk2d_s2" id="floatingTextarea2" style="height: 300px;font-size: 15px;line-height: 1.8em"><?php echo $lk2d_s2 ?></textarea>
                    </div>
                    <br>
                    <p class="title-textarea">5. Apa pengalaman bermakna yang anda alami ketika usia 3 sampai 6 tahun?</p>
                    <div class="form-floating">
                        <textarea class="form-control" name="lk2e_s2" id="floatingTextarea2" style="height: 300px;font-size: 15px;line-height: 1.8em"><?php echo $lk2e_s2 ?></textarea>
                    </div>
            </section> 
        </div>
    </div>
