...
<body>
    <div class="form-login">
        ...
        ?>
        <h2 class="mb-4 fw-bold">Masuk (admin)</h2>
        <form action="login.php" method="post">
            <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Username</label>
            <input type="text" class="form-control" name="username" value="<?php echo isset($_SESSION['username3_value']) ? $_SESSION['username3_value'] : "" ?>" id="exampleInputEmail1" aria-describedby="emailHelp">
            <?php 
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" name="password" value="<?php echo isset($_SESSION['password3_value']) ? $_SESSION['password3_value'] : "" ?>" id="exampleInputPassword1">
                <?php 
            ...
            <br>
            <br>
            <small class="sudahPunya">Kunjungi website konsultasi? <a href="index.php"><span>disini</span></a></small>
        </form>
    </div>
<img src="./image/bgnew.jpg" class="bg" alt="background" />
